...
path_inv = gen_path + 'binv/9/042_rt_binv_marm_slope_function_deg.csv'
...
class Param_class:
    "Class for the parameters definition. They are read from the raytracing output csv file"
...
#%% Extraction and interpolation of the traces
...
''' Plots shot gathers selected for both migration images detection result'''
...
#%%
''' Plots traces and detection analysis of the selected traces for both migration images'''
