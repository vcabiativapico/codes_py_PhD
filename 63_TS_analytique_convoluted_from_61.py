...
path_inv = gen_path + '063_TS_analytique/depth_demig_out/063_org_2024-08-19_12-11-20/results/depth_demig_output.csv'
path_adj  = gen_path + '063_TS_analytique/depth_demig_out/063_std_org_2024-08-19_12-11-27/results/depth_demig_output.csv'
...
# fl1 = '../input/50_ts_model/sm_ano.dat'
# fl2 = '../input/50_ts_model/sm_org.dat'
...
path_ray = gen_path + '064_TS_analytique_deep/depth_demig_out/063_org_deep_2024-08-19_11-00-05/rays/ray_0.csv'
path_ray2 = gen_path + '064_TS_analytique_deep/depth_demig_out/063_ano_deep_2024-08-19_11-00-00/rays/ray_0.csv'

path_ray = gen_path + '064_TS_analytique_deep/depth_demig_out/deeper2_org_40_2024-08-19_11-49-02/rays/ray_0.csv'
path_ray2 = gen_path + '064_TS_analytique_deep/depth_demig_out/deeper2_ano_40_2024-08-19_11-47-46/rays/ray_0.csv'



path_ray = gen_path + '063_TS_analytique/depth_demig_out/063_org_2024-08-19_12-11-20/rays/ray_0.csv'
path_ray2 = gen_path + '063_TS_analytique/depth_demig_out/063_ano_2024-08-19_12-11-16/rays/ray_0.csv'
...
f = interpolate.interp1d(ray_time_ano[:half_idx2],-betap_ray_ano[:half_idx2],kind='cubic')
# ray_time_ano_int = np.arange(0, np.max(ray_time_ano[:half_idx2]),dt/2)
ray_time_int = np.linspace(0,np.max(ray_time_ano),2000)
betap_ray_ano_int = f(ray_time_int)

f = interpolate.interp1d(ray_time_org[:half_idx],-betap_ray_org[:half_idx],kind='cubic')
# ray_time_org_int = np.arange(0, np.max(ray_time_org[:half_idx]),dt/2)
# ray_time_int = np.linspace(0,np.max(ray_time_ano[:half_idx]),2800)
...
plt.figure(figsize=(6,10))
plt.plot(betap_ray_org_int,-ray_time_int,'.')
plt.plot(betap_ray_ano_int,-ray_time_int,'*')


plt.figure(figsize=(6,10))
plt.plot(convol_time_org_int,-ray_time_int)
plt.plot(convol_time_ano_int,-ray_time_int)

new_dt =ray_time_int[51]-ray_time_int[50]

oplen = 250

SLD_TS = procs.sliding_TS(convol_time_org_int, convol_time_ano_int, oplen=oplen, si=new_dt, taper=30)
...
plt.plot(conv_t_org_norm,-ray_time_int-nws2*dt,'-')
plt.plot(conv_t_ano_norm,-ray_time_int-nws2*dt,'-')
plt.axhline(-1.19736)
plt.xlim(-1,1)
...
plt.figure(figsize=(6,12))
plt.plot(binv_SLD_TS_fwi,at,c='tab:purple')
plt.plot(SLD_TS,ray_time_int,'-')
