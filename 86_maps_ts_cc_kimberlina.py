...
# if title = 218:
    ...
    tr2 = '../output/90_kimberlina_mod_v3_high/full_sum/f_'+name+'/t1_obs_000'+str(title).zfill(3)+'.dat'
...
for i in range(0,100,100):
    ...
    if 1==1:
        ...
        fig.tight_layout()
        flout = '../png/90_kimberlina_mod_v3_high/'+name+'/TS_MAP_'+str(title*12)+'_off'+str(int(off*1000))+'.png'
        print("Export to file:", flout)
        fig.savefig(flout, bbox_inches='tight')
        ...
        plt.gca().set_aspect('equal')
        fig.tight_layout()
        flout = '../png/90_kimberlina_mod_v3_high/'+name+'/AMP_MAP_'+str(title*12)+'_off'+str(int(off*1000))+'.png'
        print("Export to file:", flout)
        fig.savefig(flout, bbox_inches='tight')
        ...
        fig.tight_layout()
        plt.gca().set_aspect('equal')
        flout = '../png/90_kimberlina_mod_v3_high/'+name+'/OVER_MAP_'+str(title*12)+'_off'+str(int(off*1000))+'.png'
        print("Export to file:", flout)
        fig.savefig(flout, bbox_inches='tight')
...
flout = '../png/90_kimberlina_mod_v3_high/'+name+'/TS_all_maps_off.png' 
print("Export to file:", flout)
fig.savefig(flout, bbox_inches='tight')
