...
fl3 = '../output/90_kimberlina_mod_v3_high/y0/inv_betap_x_s.dat'
org = gt.readbin(fl3,nz,nx)
flout = '../png/inv_betap_x_s.png'
plot_model(org)

fl4 = '../output/90_kimberlina_mod_v3_high/'+year+'/inv_betap_x_s.dat'
...
gt.writebin(kim_org_sum,'../input/90_kimberlina_mod_v3_high/full_sum/sum_kim_model_y0.dat')
gt.writebin(kim_ano_sum,'../input/90_kimberlina_mod_v3_high/full_sum/sum_kim_model_'+year+'.dat')

gt.writebin(kim_y20_part1,'../input/90_kimberlina_mod_v3_high/full_sum/sum_kim_model_'+year+'_p1.dat')
gt.writebin(kim_y20_part2,'../input/90_kimberlina_mod_v3_high/full_sum/sum_kim_model_'+year+'_p2.dat')
gt.writebin(kim_y20_part3,'../input/90_kimberlina_mod_v3_high/full_sum/sum_kim_model_'+year+'_p3.dat')

gt.writebin(kim_y10_part2_v1,'../input/90_kimberlina_mod_v3_high/full_sum/sum_kim_model_'+year+'_p2_v1.dat')
gt.writebin(kim_y10_part2_v2,'../input/90_kimberlina_mod_v3_high/full_sum/sum_kim_model_'+year+'_p2_v2.dat')

gt.writebin(kim_y20_part3_v1,'../input/90_kimberlina_mod_v3_high/full_sum/sum_kim_model_'+year+'_p3_v1.dat')
gt.writebin(kim_y20_part3_v2,'../input/90_kimberlina_mod_v3_high/full_sum/sum_kim_model_'+year+'_p3_v2.dat')
...
for i in range(30,5,-5):
    test = gt.readbin('../input/90_kimberlina_mod_v3_high/full_sum/sum_kim_model_y0.dat', 151, 601)
    test10 = gt.readbin('../input/90_kimberlina_mod_v3_high/full_sum/sum_kim_model_y'+str(i)+'_'+name+'.dat', 151, 601)
    ...
    plt.title(str(i))
    plt.colorbar(hfig)
    flout = '../png/90_kimberlina_mod_v3_high/y'+str(i)+'_'+name+'/input_diff.png' 
    print("Export to file:", flout)
    fig.savefig(flout, bbox_inches='tight')
