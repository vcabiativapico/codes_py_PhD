...
hk_s = np.zeros((nf),dtype='complex')
hk_r = np.zeros((nf),dtype='complex')

hk_s = 1j / 4. * hankel1(0., ds * aw2 / v0)
hk_r = 1j / 4. * hankel1(0., dr * aw2 / v0)
