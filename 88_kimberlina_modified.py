...
test = gt.readbin('../input/85_mix_kim_overthrust/mix_model_rs_y10.dat', 151, 601)
hmin = np.min(test)
hmax = np.max(test)
...
fl3 = '../output/85_mix_kim_overthrust/org/inv_betap_x_s.dat'
org = gt.readbin(fl3,nz,nx)
flout = '../png/inv_betap_x_s.png'
plot_model(org)

fl4 = '../output/85_mix_kim_overthrust/'+year+'/inv_betap_x_s.dat'
...
hmin = np.min(kim_ano_sum)
hmax = np.max(kim_ano_sum)
fig = plt.figure(figsize=(10, 8), facecolor="white")
av = plt.subplot(1, 1, 1)
hfig = av.imshow(kim_ano_sum,extent=[ax[0], ax[-1], az[-1], az[0]], 
                 vmin=hmin, vmax=hmax, aspect='auto',
                 cmap='jet')
plt.colorbar(hfig)
...
gt.writebin(kim_org_sum,'../input/85_mix_kim_overthrust/full_sum/sum_kim_model_y0.dat')
gt.writebin(kim_ano_sum,'../input/85_mix_kim_overthrust/full_sum/sum_kim_model_'+year+'.dat')

gt.writebin(kim_y20_part1,'../input/85_mix_kim_overthrust/full_sum/sum_kim_model_'+year+'_p1.dat')
gt.writebin(kim_y20_part2,'../input/85_mix_kim_overthrust/full_sum/sum_kim_model_'+year+'_p2.dat')
gt.writebin(kim_y20_part3,'../input/85_mix_kim_overthrust/full_sum/sum_kim_model_'+year+'_p3.dat')

gt.writebin(kim_y10_part2_v1,'../input/85_mix_kim_overthrust/full_sum/sum_kim_model_'+year+'_p2_v1.dat')
gt.writebin(kim_y10_part2_v2,'../input/85_mix_kim_overthrust/full_sum/sum_kim_model_'+year+'_p2_v2.dat')

gt.writebin(kim_y20_part3_v1,'../input/85_mix_kim_overthrust/full_sum/sum_kim_model_'+year+'_p3_v1.dat')
gt.writebin(kim_y20_part3_v2,'../input/85_mix_kim_overthrust/full_sum/sum_kim_model_'+year+'_p3_v2.dat')
...
test = gt.readbin('../input/85_mix_kim_overthrust/full_sum/sum_kim_model_y0.dat', 151, 601)
test10 = gt.readbin('../input/85_mix_kim_overthrust/full_sum/sum_kim_model_y10.dat', 151, 601)
test20 = gt.readbin('../input/85_mix_kim_overthrust/full_sum/sum_kim_model_y20.dat', 151, 601)
