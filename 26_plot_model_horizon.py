...
#%%
path_adj = '../../../../Demigration_SpotLight_Septembre2023/output/009_demig_sm_SR_az_12_all5_iz_adj.csv'
path_inv = '../../../../Demigration_SpotLight_Septembre2023/output/009_demig_sm_SR_az_12_all5_iz_inv.csv'
...
hz_inv_path_sm = '../../../../Demigration_SpotLight_Septembre2023/Demigration_Victor/pick/horizon_smooth_rc_norm_12.csv'
hz_inv_path_org = '../../../../Demigration_SpotLight_Septembre2023/Demigration_Victor/pick/horizon_rc_norm_12.csv'
...
plot_mig_hz(mig_badj,horizon_adj_sm)
plt.plot(spot_x_inv,spot_z_inv,'.k')

plot_mig_hz(mig_binv,horizon_inv_sm)
plt.plot(spot_x_inv,spot_z_inv,'.k')

## Plot overlay model + horizons as ORIGINALLY PICKED + spots
plt.figure(figsize=(13,7))
plot_mig_hz(mig_badj,horizon_adj_org)
plt.plot(spot_x_adj,spot_z_adj,'.k')

plot_mig_hz(mig_binv,horizon_inv_org)
plt.plot(spot_x_inv,spot_z_inv,'.k')


## Plot horizons smoothed
plt.figure(figsize=(13,7))
plt.plot(ax[:600],horizon_inv_sm,'.b')
plt.plot(ax[:600],horizon_adj_sm,'.r')
plt.tight_layout()
...
plt.figure(figsize=(13,7))
plt.plot(ax[:600],horizon_inv_org,'.b')
plt.plot(ax[:600],horizon_adj_org,'.r')
plt.tight_layout()
plt.legend(['Quantitative','Standard'])
plt.ylim(1200,1500)
plt.xlabel('Distance (km)')
...
hz_delta_sm = np.arange(600)
hz_delta_org = np.arange(600)
hz_sm_org = np.arange(600)
...
plt.figure(figsize=(13,7))
plt.plot(ax[:600],hz_delta_org,'.k')
...
# Read horizons
hz_adj_marm_sm = '../../../../Demigration_SpotLight_Septembre2023/Demigration_Victor/pick/27_hz_sm3_marm_adj_01.csv'
hz_adj_marm_org = '../../../../Demigration_SpotLight_Septembre2023/Demigration_Victor/pick/27_hz_marm_adj_01.csv'
...
plt.legend(['inv','adj','diff'])
plt.title('horizons inv vs adj and its differnce')
plt.gca().invert_yaxis()
...
plot_mig_hz(marm_mig_binv,hz_inv_marm_sm)
...
plot_mig_hz(marm_mig_badj,hz_adj_marm_sm)
for i in range(len(spot_x_inv)):
