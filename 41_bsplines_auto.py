...
np.savetxt('../../../../Demigration_SpotLight_Septembre2023/Demigration_Victor/040_weights_hz_marm_binv_smpick_neg.csv',Weight_2D_inline,fmt='%f',delimiter=',') 


#%% Visualisations B-splines horizon


Param_File = '../../../../Demigration_SpotLight_Septembre2023/Demigration_Victor/040_Param_marm_smooth.csv'

inv_Weight_File = '../../../../Demigration_SpotLight_Septembre2023/Demigration_Victor/040_weights_hz_marm_binv_smpick_neg.csv'
...
for x_ind in x:
    print(x_ind)
    INL11,XL11 = INL_XL_z_infos(y, x_ind, Param_Input1)
    print(INL11,XL11)
    hz = Horizon(INL11, XL11, Param_Input_inv, inv_Weights_Horizon)
    horizon.append(hz)
...
file = '../output/40_marm_ano/b'+name+'/inv_betap_x_s.dat'
model_mig = readbin(file,151,601).T

bs_horizon_inv= horizon

hz_inv_marm_sm = '../input/40_marm_ano/b'+name+'_mig_pick_smooth.csv'
...
plt.imshow(model_mig.T,vmin=hmin, vmax=hmax,aspect = 2, 
...
plt.plot(bs_horizon_inv,'k')



#%% Visualisation B-splines model
