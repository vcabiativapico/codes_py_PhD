...
np.savetxt('../../../../Demigration_SpotLight_Septembre2023/Demigration_Victor/010_Parametres_vel_marm_sm_PP21.csv', Param_Exit, fmt='%f',delimiter=",")   

np.savetxt('../../../../Demigration_SpotLight_Septembre2023/Demigration_Victor/010_Weights_vel_marm_sm_PP21.csv',Weights,fmt='%f',delimiter=',') 
